...
public class Q3_13 {
	...
	public static void main(String[] args) {
		...
		System.out.print("(0-single filer,1-married jointly or"+"qualifying window(er),"
				+ "2-married seperately,3-head of "
		...
		case 0: 
			if(income <= 8350) {
				...
				tax = 8350*0.10+(33950-8350)*0.15+(52250-33950)*0.25+(income-52250)*0.28;
			}
			else if (income<=372950) {
				tax = 8350*0.10+(33950-8350)*0.15+(52250-33950)*0.25+(171550-52250)*0.28+(income-171550)*0.33;
			}
			else if (income > 372950){
				tax = 8350*0.10+(33950-8350)*0.15+(52250-33950)*0.25+
						(171550-52250)*0.28+(372950-171550)*0.33+(income-372950)*0.35; 
		...
		case 2: 
			if(income <= 8350) {
				...
				tax = 8350*0.10+(33950-8350)*0.15+(68525-33950)*0.25+
						(104425-68525)*0.28+(186475-104425)*0.33+(income-186475)*0.35; break;
		...
		case 3:
			if(income <= 11950) {
				...
				tax = 11950*0.10+(income-104425)*0.15;
				...
				tax = 11950*0.10+(45500-11950)*0.15+(117450-45500)*0.25+
						(190200-117450)*0.28+(372950-190200)*0.33+(income-372950)*0.35; break;
